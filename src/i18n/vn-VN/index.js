export default {
  ...
  'Search for restaurant': 'Tìm kiếm nhà hàng',
  ...
  //Map
  'Enter the restaurant name': 'Nhập tên nhà hàng',
  'Hide search box': 'Ẩn ô tìm kiếm',
  'Show search box': 'Hiện ô tìm kiếm',
  'Add new restaurant': 'Thêm nhà hàng mới',
  ...
  'Edit restaurant information': 'Sửa thông tin nhà hàng',
  'Are you sure you want to delete this restaurant?': 'Bạn có chắc chắn muốn xóa nhà hàng này?',
  'No name': 'Không có tên',
  Unknown: 'Không rõ',
  'No address information available': 'Không có thông tin địa chỉ',
  'Da Nang Boundary': 'Ranh giới Đà Nẵng',
  'Blur Layer for Other Provinces/Cities': 'Lớp mờ các tỉnh/thành khác',
  'Search error': 'Lỗi tìm kiếm',
  'No restaurants found with the name containing': 'Không tìm thấy nhà hàng nào có tên chứa',
  // operator
  EQUALS: 'Bằng',
